...
define('k1app\K1APP_CONTROLLERS_PATH', K1APP_ROOT . '/src/controllers/'); // 2.0
...
set_include_path(K1APP_SETTINGS_PATH . PATH_SEPARATOR . K1APP_ASSETS_PATH . '/includes' . PATH_SEPARATOR . get_include_path());
